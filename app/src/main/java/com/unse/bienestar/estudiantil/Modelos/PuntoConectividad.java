...
public class PuntoConectividad implements Parcelable {
    ...
    public static final int LUGAR = 6;

    private int id, idUsuario, dia, mes, anio, estado, validez, lugar, cantidad, disponible, turno;
    private String descripcion, nombreLugar, fechaRegistro, fechaModificacion, horario,
    ...
    public static PuntoConectividad mapper(JSONObject o, int tipo) {
        ...
        int id, idUsuario, dia, mes, anio, estado, validez, lugar, cantidad, disponible, turno;
        String descripcion, nombreLugar, horario, fechaRegistro, fechaModificacion, nombre, contacto, apellido;
        ...
        try {
            switch (tipo) {
                ...
                case LUGAR:
                    nombreLugar = o.getString("descripcion");
                    id = Integer.parseInt(o.getString("id"));
                    contacto = o.isNull("contacto") ? " " : o.getString("contacto");
                    disponible = Integer.parseInt(o.getString("disponible"));
                    turno = Integer.parseInt(o.getString("turno"));
                    puntoConectividad = new PuntoConectividad(id, disponible, turno, nombreLugar, contacto);
                    break;
            }
    ...
    public PuntoConectividad(int id, int disponible, int turno, String nombreLugar, String contacto) {
        this.id = id;
        this.disponible = disponible;
        this.turno = turno;
        this.nombreLugar = nombreLugar;
