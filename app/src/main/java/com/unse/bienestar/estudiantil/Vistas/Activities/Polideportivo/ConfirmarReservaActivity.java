...
import com.unse.bienestar.estudiantil.Modelos.Espacio;
import com.unse.bienestar.estudiantil.R;
import com.unse.bienestar.estudiantil.Vistas.Adaptadores.EspaciosAdapter;
...
public class ConfirmarReservaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void loadData() {
       ...
       // models.add(new Espacio(R.drawable.imgborrar1, "Salón", "$4200", "Salón de X por Y dimensiones para tus eventos, cuenta con cosa1, cosa2, cosa3..."));
