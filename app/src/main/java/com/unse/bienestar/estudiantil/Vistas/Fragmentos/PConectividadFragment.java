...
public class PConectividadFragment extends Fragment implements View.OnClickListener {

    View view;
    CardView cardTurnos, cardInfo, cardWsp;
    Context mContext;

    public PConectividadFragment() {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.cardTurnos:
                if (isLogin)
                    startActivity(new Intent(getContext(), NewTurnoConectividadActivity.class));
                break;
